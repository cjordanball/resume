export const priorJobs = [
	{
		...
		description: 'Software engineer working to create awe-inspiring apps the web and mobile devices. Part of team creating Webby award-winning app for Meals on Wheels.'
	},
	{
		...
		endMonthYear: null,
		description: 'Founder and member of group performing classical music for weddings, receiptions an similar events. In addition to performing on viola and classical guitar, I have been the primary responsible individual for organizing rehearsals and recording sessions, creation of website at <a>AnArrayofStrings.com</>.'
	},
	{
	...
	},
	{
		...
		beginMonthYear: 'January 2018',
		endMonthYear: null,
		description: 'Developer of online video course content for aspiring programmers/web developers.  Solely responsible for all aspects of creation of two courses published on Udemy.com with perfect 5-Star ratings, <em>JumpStart JavaScript</em> and <em>The Joy of RegEx!</em>, including research and writing, scripting, filming, editing, and publication.',
	},
	{
		...
		description: 'Contract position working with Anthem scrum team responsible for user-facing portion of website of Fortune 50 company servicing millions of client accounts. Implementing designs in Angular, extensive writing of unit tests, working with Agile/SAFE team of developers, UX testers, and designers.'
	},
	{
		companyName: 'Shockoe',
		active: false,
